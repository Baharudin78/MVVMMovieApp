...
import com.baharudin.movieapp.adapter.FavoriteAdapter
import com.baharudin.movieapp.data.local.FavoriteMovie
import com.baharudin.movieapp.data.remote.Movie
import com.baharudin.movieapp.databinding.FragmentFavoriteBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter.setOnItemClickCallback(object : FavoriteAdapter.OnItemClickCallback{
            override fun onItemClick(favoriteMovie: FavoriteMovie) {
                ...
                val action = FavoriteFragmentDirections.actionIdFavoriteToNavDetails(movie)
